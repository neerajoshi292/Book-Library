...
import aboutImg from "../images/tim.jpg";
    ...
    <>
        <section className= {css.about}>
            <div className='container'>
                ...
                <div className= {`${css["about-content"]} grid`}>
                <div className={`${css["about-img"]}`}>
                    <img src = {aboutImg} alt = "bookstore" />
                </div>
                <div className={`${css["about-text"]}`}>
                    <h2 className= {`${css["about-title"]} fs-26 ls-1`}>About BookHub</h2>
